...
class Test:
    ...
    def initialize(self):
        main_positions = [(0, 1),(6, 1),(0, 5),(6, 5)]
        ...
        left_positions = [(1,5), (2,5), (3,5), (4,5), (5,5)]
        for x, y in left_positions:
            self.grid.set_cell_type(x, y, GRID_TYPE_MAIN_CHANNEL)
            self.grid.set_cell_directions(x, y, ["left", "up", "down"])

        right_positions = [(1, 1), (2, 1), (3, 1), (4, 1), (5, 1)]
        for x, y in right_positions:
            self.grid.set_cell_type(x, y, GRID_TYPE_MAIN_CHANNEL)
            self.grid.set_cell_directions(x, y, ["right", "up", "down"])
        ...
        for y in range(self.grid.height):
            for x in range(self.grid.width):
                if (x, y) not in main_positions and (x, y) not in left_positions and (x, y) not in right_positions and (x, y) not in up_down_positions:
