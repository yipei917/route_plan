...
class Test:
    ...
    def __init__(self, num_vehicles: int = 2, width: int = 7, height: int = 5):
        ...
        self.grid_visualizer = GridVisualizer(self.grid, figsize=(35, 25))

    def initialize(self):
        main_positions = [(0,1), (1,1), (2,1), (3,1), (4,1), (5,1), (6,1)]
        ...
        for i in range(self.num_vehicles):
            vehicle = Vehicle(id=f"V{i + 1:03d}", vehicle_type=VEHICLE_TYPE_EMPTY, current_position=v_positions[i])
            self.vehicles.append(vehicle)
            self.constraint_manager.add_vehicle(vehicle)
            self.grid_visualizer.add_vehicle(vehicle)

        self.task_manager.add_task(task_type=TASK_TYPE_INBOUND, start_pos=(0,1), end_pos=(6,4))
        self.task_manager.add_task(task_type=TASK_TYPE_INBOUND, start_pos=(0,1), end_pos=(6,3))
        self.task_manager.add_task(task_type=TASK_TYPE_INBOUND, start_pos=(0,1), end_pos=(6,2))
        self.task_manager.add_task(task_type=TASK_TYPE_INBOUND, start_pos=(0,1), end_pos=(5,4))
    ...
    def simulate_step(self):
        ...
        for vehicle in active_vehicles:
            ...
            if vehicle.current_position == task.start_position:
                ...
                if vehicle.vehicle_type == VEHICLE_TYPE_EMPTY:
                    continue
